...
//aded by hafsa 
const  Affectation = Frame.define(
  table('affectation'),
  'id', readable,
  'mobile_user_id', readable, writable,
  'city_name', readable, writable,
  'local_area_name', readable, writable,
  'street_name', readable, writable,
  'project_code', readable, writable,
  'property_name', readable, writable,
  'property_longitude', readable, writable,
  'property_latitude', readable, writable,
  'property_type', readable, writable,
  'apartment_name', readable, writable,
  'co_name', readable, writable,
  'olt_name', readable, writable,
  'olt_slot_no', readable, writable,
  'olt_port_no', readable, writable,
  'prestataire', readable, writable,
  'date_de_declaration', readable, writable,
  'potentiel', readable, writable,
  'typologie', readable, writable,
  'created_at', readable
); 
