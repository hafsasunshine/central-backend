...
const messages = {
  ...
  // New message format for sending generated password (added by hafsa)
  passwordEmail: message('Your Generated Password', '<html><p>Your generated password is: <strong>{{password}}</strong></p></html>')
};
